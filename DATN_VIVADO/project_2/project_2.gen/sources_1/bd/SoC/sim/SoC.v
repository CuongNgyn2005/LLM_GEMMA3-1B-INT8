...
//Date        : Sat Aug 22 12:35:24 2026
//Host        : Cuong-Desktop running 64-bit major release  (build 9200)
...
(* CORE_GENERATION_INFO = "SoC,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=SoC,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_zynq_ultra_ps_e_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "SoC.hwdef" *) 
module SoC
   ();
  ...
  SoC_VPU_Top_0_0 VPU_Top_0
       (.s00_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s00_axi_aruser(axi_smc_M00_AXI_ARUSER[0]),
        ...
        .s00_axi_awuser(axi_smc_M00_AXI_AWUSER[0]),
  ...
  SoC_rst_ps8_0_100M_0 rst_ps8_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
